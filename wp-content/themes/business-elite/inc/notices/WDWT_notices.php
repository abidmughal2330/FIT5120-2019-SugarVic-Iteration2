...
class WDWT_Notices {
	...
	public function wd_admin_notices() {
		...
		$notices['one_week_support'] = array(
			...
			'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="'.  WDWT_HOMEPAGE . '/theme-guide/introduction.html">' . __('Check out User Guide', WDWT_LANG) . '</a></li>
