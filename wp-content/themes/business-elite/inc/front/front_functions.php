...
class Business_elite_frontend_functions extends WDWT_frontend_functions
{
  ...
  public static function posted_on_single()
  {
    ...
    printf('<span class="date_link"><span class="sep date"></span><span class="screen-reader-text">' . __('Posted on', WDWT_LANG) . '</span><a href="%1$s" title="%2$s" rel="bookmark">' . $time_string . '</a></span><span class="by-author"> <span class="sep author"></span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>',
                ...
                <li>
                  ...
                  <div class="top_content">
                    ...
                    <div class="more_info_tpost">
                      <a class="tab-more"
                         href="<?php echo get_permalink(); ?>"><?php echo __('More Info', WDWT_LANG); ?>  </a>
                    </div>
                  </div>
                </li>
                <?php
                  ...
                  <ul>
                    ...
                    if (isset($top_tabs_category['recent'])) {
                      ...
                      if ($tabs_query->have_posts()) : while ($tabs_query->have_posts()) : $tabs_query->the_post();
                        ...
                        $listt .= '<div class="slaq"><a href="' . get_permalink() . '">' . __("Read more", WDWT_LANG) . '</a></div></div></li>';
                        echo $listt;
                      endwhile;
  ...
  public static function category_tab_ajax($cat_paged = 1, $cat_id = 0, $key = 0, $lang = false)
  {
    ...
    if ($tabs_query->have_posts()) : while ($tabs_query->have_posts()) : $tabs_query->the_post();
      ...
      $listt .= '<div class="slaq"><a href="' . get_permalink() . '">' . __("Read more", WDWT_LANG) . '</a></div>
            </div></li>';
      echo $listt;
    endwhile;endif;
    $queried_object = $tabs_query->get_queried_object();;
              ...
              while ($wp_query->have_posts()) {
                ...
                <div class="content-post post_image slide-in-right">
                  ...
                  <div class="home_blog_post">
                    ...
                    <div class="more_info">
                      <a class="tab-more"
                         href="<?php echo get_permalink(); ?>"><?php echo __('Read more', WDWT_LANG); ?></a>
      ...
      if ($content_posts_enable) {
        ...
        if ($paged > 1) { ?>
          <span class="content_posts_home_pagination" id="content_posts_home_left"
              ...
              class="fa fa-chevron-left"></i><?php esc_html_e('Previous', WDWT_LANG); ?> </span>
          <?php
        }
        if ($paged < $wp_query->max_num_pages) { ?>
          <span class="content_posts_home_pagination" id="content_posts_home_right"
                onclick="wdwt_front_ajax_pagination(<?php echo $paged + 1; ?>, 'content_posts', '#blog_home_out');"><?php esc_html_e('Next', WDWT_LANG); ?>
        ...
        <div id="portfolio-block" class="portfolio_home" style="clear:both;">
          ...
          if ($paged < $wp_query->max_num_pages) { ?>
            <span class="portfolio_home_pagination" id="portfolio_home_right"
                  onclick="wdwt_front_ajax_pagination(<?php echo $paged + 1; ?>, 'portfolio_home', '#portfolio_home_out');"><?php esc_html_e('Next', WDWT_LANG); ?>
              <i class="fa fa-chevron-right"></i></span>
            <?php
          }
          ?>
        ...
        <ul class="cont_us_top container">
          <?php if ($contact_us_name) { ?>
            ...
            <li>
              ...
              <div><p class="cont_title"> <?php echo __('FULL NAME', WDWT_LANG); ?> </p>
          ...
          <?php if ($contact_us_address) { ?>
            ...
            <li>
              ...
              <div><p class="cont_title"> <?php echo __('ADDRESS', WDWT_LANG); ?> </p>
          ...
          <?php if ($contact_us_mail && $contact_us_showmail) { ?>
            ...
            <li>
              ...
              <div><p class="cont_title"> <?php echo __('EMAIL', WDWT_LANG); ?> </p>
