...
/* ------- option parameter example -------
  'seo_home_title' => array( 
        'name' => 'seo_home_title', 
        'title' => __( 'Custom Title', WDWT_LANG ), 
        'type' => 'checkbox_open', 
        'section' => 'seo_home', 
        'tab' => 'seo', 
        'default' => ''
        'description' => __( 'Check the box to use a custom title for the website. By default it takes the combination of the website name and its description.', WDWT_LANG ),  
...
function wdwt_get_tabs() {
  ...
  $tabs['homepage'] = array(
    ...
    'sections' => array(
      'homepage_top_posts' => array(
        ...
        'description' => sprintf( __( 'Create custom link menu item with URL %s to scroll to top posts.', WDWT_LANG ), get_home_url().'?#top_posts' )
      ),
      'homepage_tabs' => array(
        'name' => 'homepage_tabs',
        'title' => __( 'Category Tabs', WDWT_LANG ),
        'description' => sprintf( __( 'Create custom link menu item with URL %s to scroll to category tabs.', WDWT_LANG ), get_home_url().'?#category_tabs' )
      ),
      'homepage_featured_post' => array(
        'name' => 'homepage_featured_post',
        'title' => __( 'Featured Post', WDWT_LANG ),
        'description' => sprintf( __( 'Create custom link menu item with URL %s to scroll to featured post.', WDWT_LANG ), get_home_url().'?#featurd_post' )
      ),
      'homepage_content_posts' => array(
        'name' => 'homepage_content_posts',
        'title' => __( 'Content Posts', WDWT_LANG ),
        'description' => sprintf( __( 'Create custom link menu item with URL %s to scroll to blog content posts.', WDWT_LANG ), get_home_url().'?#blog' )
      ),
      'homepage_portfolio' => array(
        'name' => 'homepage_portfolio',
        'title' => __( 'Portfolio', WDWT_LANG ),
        'description' => sprintf( __( 'Create custom link menu item with URL %s to scroll to portfolio posts.', WDWT_LANG ), get_home_url().'?#portfolio' )
      ),
      'homepage_contact' => array(
        'name' => 'homepage_contact',
        'title' => __( 'Contact', WDWT_LANG ),
        'description' => __( 'Frontpage Contact form is disabled in free version.', WDWT_LANG )
      ),
      'homepage_links' => array(
        'name' => 'homepage_links',
        'title' => __( 'Links', WDWT_LANG ),
        'description' => ''
      ),
    ),
  ...
  $tabs['typography'] = array(
    ...
    'sections' => array(
      ...
      'primary_font' => array(
        'name' => 'primary_font',
        'title' => __( 'Primary text font', WDWT_LANG ),
        'description' => ''
      ),
