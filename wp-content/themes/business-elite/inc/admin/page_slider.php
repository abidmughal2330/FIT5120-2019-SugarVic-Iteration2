  ...
  function __construct()
  {
    ...
    if (is_plugin_active('slider-wd/slider-wd.php')) {
      ...
      $this->options['show_slider_wd'] = array(
        "name" => "show_slider_wd",
        "title" => __("Use Slider WD in header", WDWT_LANG),
        'type' => 'checkbox_open',
    ...
    $this->options['hide_slider'] = array(
      ...
      'name' => 'hide_slider',
      'title' => __('Specify where slider should be shown.', WDWT_LANG),
      'type' => 'select',
      'valid_options' => array(
        "Only on Homepage" => __("Only on homepage", WDWT_LANG),
        "Only on Front Page" => __("Only on front page", WDWT_LANG),
        "On all the pages and posts" => __("On all the pages and posts", WDWT_LANG),
        "Hide Slider" => __("Hide Slider", WDWT_LANG),
      ),
      'description' => __('Tip: set "Only on front page" if front page displays "a static page".', WDWT_LANG),
      'section' => 'slider_main',
      'tab' => 'slider',
    ...
    $this->options['disable_slider_on_mobile'] = array(
      ...
      'title' => __('Disable slider on mobile.', WDWT_LANG),
      'type' => 'checkbox',
      'description' => __('Disable slider on mobile.', WDWT_LANG),
      'section' => 'slider_main',
      'tab' => 'slider',
      'default' => false,
      'customizer' => array()
    ...
    $this->options["image_height"] = array(
      "name" => "image_height",
      "title" => __("Slider Height", WDWT_LANG),
      'type' => 'number',
      "sanitize_type" => "sanitize_text_field",
      "description" => __("Slider with the width of 1024px will have this height. When resized, image dimensions ratio is preserved.", WDWT_LANG),
      'section' => 'slider_main',
      'min' => '240',
      'max' => '1200',
      'unit_symbol' => 'px',
    ...
    $this->options["animation_speed"] = array(
      ...
      "title" => __("Animation Speed", WDWT_LANG),
      'type' => 'number',
      "sanitize_type" => "sanitize_text_field",
      "description" => __("When using an animation for the slider, you can control its speed. You can use the provided box to fill in the optimal speed.", WDWT_LANG),
      'section' => 'slider_main',
      'tab' => 'slider',
      'unit_symbol' => 'msec',
      'min' => '200',
    ...
    $this->options["slideshow_interval"] = array(
      ...
      "title" => __("Pause Time", WDWT_LANG),
      'type' => 'number',
      "sanitize_type" => "sanitize_text_field",
      "description" => __("The timing for the slider animation can be customized. You can adjust it providing timing in the corresponding box.", WDWT_LANG),
      'section' => 'slider_main',
      'unit_symbol' => 'msec',
      'tab' => 'slider',
      'min' => '1000',
    ...
    $this->options["stop_on_hover"] = array(
      ...
      'type' => 'checkbox',
      "sanitize_type" => "sanitize_text_field",
      "description" => __("By default slider animation is constant. However you can choose it to stop while hovering, checking the box for this option.", WDWT_LANG),
      'section' => 'slider_main',
      'tab' => 'slider',
      'default' => false,
      'customizer' => array()
    ...
    $this->options["effect"] = array(
      "name" => "effect",
      "title" => __("Effect", WDWT_LANG),
      'type' => 'select',
      "sanitize_type" => "sanitize_text_field",
      "description" => __("The animation of the slider can be customized with the help of various effects. You can choose the slider animation effect from the list included below.", WDWT_LANG),
      "valid_options" => array(
        "none" => "None",
    ...
    $this->options["title_position"] = array(
      "name" => "title_position",
      "title" => __("Title Position", WDWT_LANG),
      'type' => 'select',
      "sanitize_type" => "sanitize_text_field",
      "description" => "",
      "valid_options" => array(
    ...
    $this->options["description_position"] = array(
      ...
      "title" => __("Description Position", WDWT_LANG),
      'type' => 'select',
      "sanitize_type" => "sanitize_text_field",
      "description" => "",
      "valid_options" => array(
