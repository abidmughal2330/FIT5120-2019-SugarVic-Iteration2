...
function wdwt_section_descr($wdwt_tab='general') {
  ...
  '<span class="user_manual">
        <span style="float:left;">
          <a href="'.WDWT_HOMEPAGE . "/theme-guide/introduction.html".'" target="_blank" class="user_title">'. __("User Manual.", WDWT_LANG).'</a>
          <br /><span style="font-size:1.2em;">'.esc_html($text) .'</span>
          <a href="'.$url.'" target="_blank" class="user_more">' . __('More', WDWT_LANG). '... </a>
