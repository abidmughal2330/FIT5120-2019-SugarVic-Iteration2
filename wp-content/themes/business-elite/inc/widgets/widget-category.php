...
class Business_elite_categ extends WP_Widget
{
  ...
  function form($instance)
  {
    ...
    <p>
      <label for="<?php echo $this->get_field_id('categ_id'); ?>"><?php _e("Select Category:", WDWT_LANG); ?></label>
      <select name="<?php echo $this->get_field_name('categ_id'); ?>" id="<?php echo $this->get_field_id('categ_id') ?>"
        ...
        <option value="0"><?php _e("Select Category:", WDWT_LANG); ?></option>
        <?php
    ...
    <p>
      <label
        for="<?php echo $this->get_field_id('post_count'); ?>"><?php _e("Number of Posts:", WDWT_LANG); ?></label><input
