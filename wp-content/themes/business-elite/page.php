		...
		<div id="blog" class="blog">
			...
			<?php endwhile; ?>
				...
				<div class="navigation">
					<?php				wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . __( 'Page',  WDWT_LANG ) . '</span>', 'after' => '</div>', 'link_before' => '<span class="page-links-number">', 'link_after' => '</span>' ) ); ?>
				</div>
			<?php endif; ?>
			<div class="clear"></div>
