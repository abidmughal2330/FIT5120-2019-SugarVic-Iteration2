...
$cfg['blowfish_secret']					= '7{w+r}GW&^-#Mt>GmdQu1-;dsEw@diqq' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('bitnami_wordpress') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_4yGIqUkNT7YHvRo9uFhc5fa/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
