...
class Elements_API extends Base {
	...
	public function get_token_url() {
		...
		return $this->api_hostname . "/extensions/begin_activation?extension_id=" . $this->get_extension_id() . "&extension_type=envato-wordpress&extension_description=" . urlencode( $extension_description );
	}
