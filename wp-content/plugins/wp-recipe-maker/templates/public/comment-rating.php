...
?>
<img class="wprm-comment-rating" src="data:image/gif;base64,R0lGODdhAQABAPAAAP///wAAACwAAAAAAQABAEACAkQBADs=" data-lazy-src="<?php echo $svg; ?>" width="80" height="16" />
<?php else : ?>
<img class="wprm-comment-rating" src="<?php echo $svg; ?>" width="80" height="16" />
